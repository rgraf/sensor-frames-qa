...
##
#-------------------------------------------------------------------------------
# Name: compare_screenshots_gui.py
...
def explore_match(win, img1, img2, kp_pairs, status = None, H = None):
    ...
    img = cv2.resize(vis, (600,500)) # book
    cv2.imshow(win, img)
...
# tr1 is a threshold for high similarity between snapshots
# tr2 is a threshold for small differencies
